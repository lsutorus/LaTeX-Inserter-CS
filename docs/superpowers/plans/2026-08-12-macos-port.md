...
| 12 — Overlay focus + paste timing | ⏳ next session | — | Rewrite `InputSimulatorService`; check `IInputSimulatorService` event declaration. |
